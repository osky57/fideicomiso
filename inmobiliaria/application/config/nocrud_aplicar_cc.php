...
$config['modelo']         = 'Aplicarcc_model';
$config['urlApliCC']      = '/index.php/'.$config['nombreInfo'].'/aplicarcc';
$config['urlGrabaApliCC'] = '/index.php/'.$config['nombreInfo'].'/grabaaplicarcc';
