<?php $id_form=uniqid();?>
<form id="<?=$id_form;?>" action="<?php echo base_url('index.php/movbancarios/guardaRegistro') ?>" method="POST"  data-validation="valida_cta_cte">
	...
	<div class="row mi_padd">
		...
		<div class="col-sm-3">
			<label for="frm_tipo_comprobante_id">Tipo de medio</label>
