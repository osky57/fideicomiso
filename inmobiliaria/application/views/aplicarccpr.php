...
<div class="row" id="divaplicc" name="divaplicc">
    <div class="main" style='padding-left:15px;'>
	<h5><b>
	Aplicaciones de Cuentas Corrientes Prestamistas
	</b></h5>
	...
	<div style='padding-top:20px;'>
	    <form action="<?php echo base_url('index.php/aplicarccpr/aplicarcc') ?>" method="POST" id="myForm">
...
//console.log(elId);
//console.log(trStart21[8]);

//llamar validacion por ajax con elId (comprobante destino Fac ND) y trStart21[8] (comprobante origen, O/P NC)
//formato: 
//     t1_id_686   fact.
//     t2_id_701   o/p
			...
			$.ajax({
			    url   : "<?=$urlxValiApliCCPR;?>",
			    type  : 'GET',
			    async : false,
			    data  : { tr1 : elId, tr2 : trStart21[8] },
			    dataType : 'json',
...
console.log("lPermite");

console.log(lPermite);
			if (lPermite == 0){
			    alert("La aplicación no es permitida, verifique los medios de pagos de la O/P y el fideicomiso y tipo de comprobante del proveedor");
			}else{
