...
class Proyectostipospropiedades extends CI_Controller {							// **->
	...
	public function index(){
		...
		$datos['urlsubform'] = $this->config->item('urlSubForm');
	...
	public function recuperaPagina(){
	    ...
	    $enti    = new Proyectostipospropiedades_model();						// **->
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	//////para este crud poder abrir otro formulario
	//////////////////////////////////////////////////////////////////////////////////////////
	public function cargaSubFormulario(){
		$elId         = isset($_GET['id']) ? $_GET['id'] : 0;
		$vista        = $_GET['name'];
		$enti         = new Proyectostipospropiedades_model();						// **->
		$data         = $enti->devuelvePropietariosPropiedad($elId);
		$data['elid'] = $elId;
		//en $data['duenios'] estan los propietarios de esa propiedad
		//en $data['entidades'] estan las entidades inversoras del proyecto, 
		//si un prestamista compra una propiedad, hay q indicar q tambien es inversor
		$this->load->view($vista,$data);
	}

	//////////////////////////////////////////////////////////////////////////////////////////
	public function guardaProyPropie(){
		$data = $_POST;
		$enti = new Proyectostipospropiedades_model();						// **->
		$enti->guardaDetalleProyectoPropiedad($data);
	}
