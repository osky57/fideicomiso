...
class Proyectosentidades extends CI_Controller {								// **->
	...
	public function recuperaPagina(){
	    ...
	    $enti    = new Proyectosentidades_model();							// **->
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	//////para este crud poder abrir otro formulario (ctas ctes de entidades del proyecto)////
	//////////////////////////////////////////////////////////////////////////////////////////
	public function cargaSubFormulario(){
		$elId               = isset($_GET['id']) ? $_GET['id'] : 0;
		$vista              = $_GET['name'];
//		$enti               = new Proyectosentidades_model();					// **->
//		$data['cc']         = $enti->devuelveCtaCte($elId);

		$data['idInv']      = $elId;
		$data['urlxResuCC'] = $this->config->item('urlRecuCC');
		$this->load->view($vista,$data);
	}

	//////////////////////////////////////////////////////////////////////////////////////////
	public function recargaCC(){
		$elId               = isset($_GET['id']) ? $_GET['id'] : 0;
		$enti               = new Proyectosentidades_model();					// **->
		$retorno            = $enti->devuelveCtaCte($elId);
		echo json_encode($retorno);
	}
