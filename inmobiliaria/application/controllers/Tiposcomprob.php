...
class Tiposcomprob extends CI_Controller {								// **->
	...
	public function guardaRegistro(){
		$data = $_POST;
		$enti = new Tiposcomprob_model();						// **->
		if ($enti->guardaUnRegistro($data)){
		    wh_log("GUARDO TIPO COMPROB");
		}else{
		    wh_log("NO   GUARDO TIPO COMPROB");
		}
